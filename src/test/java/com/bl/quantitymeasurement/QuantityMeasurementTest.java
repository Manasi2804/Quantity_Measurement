...
public class QuantityMeasurementTest {
    ...
    @Test
    public void givenTwoInchAndTwoInch_WhenNegative_ShouldReturnException() {
        try {
            double Value1 = quantityMeasurement.getUnit(Units.INCH, -2.0);
            double Value2 = quantityMeasurement.getUnit(Units.INCH, 2.0);
            Assert.assertEquals(Value1, Value2, 0.0);
    ...
    public void givenOneGallonAndThreePointSevenEightLitValue_WhenEqual_ShouldReturnTrue() {
        double Value1 = quantityMeasurement.getUnit(Units.GALLON, 1.0);
    ...
    public void givenOneLitreAndOneThousandMilliLitre_WhenEqual_ShouldReturnTrue() {
        ...
        double Value2 = quantityMeasurement.getUnit(Units.MILLILITER, 1000);
        Assert.assertEquals(Value1, Value2, 0.0);
    }
    @Test
    ...
    public void givenOneTonneAndOneThousandGrams_WhenAdded_ShouldReturnResult() {
        double Value1 = quantityMeasurement.getUnit(Units.TONNE, 1.0);
        double Value2 = quantityMeasurement.getUnit(Units.GRAMS, 1000.0);
    ...
    public void givenOneTonneAndOneThousandGrams_WhenNegative_ShouldReturnException() {
        try {
            double Value1 = quantityMeasurement.getUnit(Units.TONNE, -1.0);
            double Value2 = quantityMeasurement.getUnit(Units.GRAMS, 1000);
            Assert.assertEquals(Value1, Value2, 0.0);
        } catch (QuantityMeasurementException e) {
            Assert.assertEquals("Value Should be Correct", e.getMessage());
        }
    ...
    @Test
    public void givenTwoOneTwoFahrenheitAndHundredCel_WhenEqual_ShouldReturnResult() {
        double Value1 = quantityMeasurement.getUnit(Units.FAHRENHEIT, 212);
        double Value2 = quantityMeasurement.getUnit(Units.CELSIUS, 100);
        Assert.assertEquals(Value1, Value2, 0.0);
    }
}